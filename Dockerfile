...
ADD https://github.com/sacloud/terraform-provider-sakuracloud/releases/download/v2.0.0/terraform-provider-sakuracloud_2.0.0_linux-amd64.zip ./
RUN unzip terraform-provider-sakuracloud_2.0.0_linux-amd64.zip -d ~/.terraform.d/plugins/linux_amd64
RUN rm -f terraform-provider-sakuracloud_2.0.0_linux-amd64.zip
